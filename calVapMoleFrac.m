...
%% This function evaluates the vapor mole fraction from the saturation/partial pressure.

function [moleFraction] = calVapMoleFrac(ambientPressure, saturationPressure, calMethod)
...
if mikhil == 1 
    ...
    moleFraction = saturationPressure / ambientPressure ; 

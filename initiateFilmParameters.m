...
%% This function defines the weights for evaluation of film temperature. 
%  Thermophysical properties for the liquid phase are evaluated at the droplet temperature. 
%  Thermophysical properties for the vapor phase are evaluated at the a film temperature. 
%  Thermophysical properties for the ambient gas are evaluated at the the ambient temperature.
%  filmTemperature = dropletSurfaceTemperature (1-filmRuleParameter) + Tamb

function [filmParameter_gas, filmParameter_vapor, filmParameter_liquid] = initiateFilmParameters()

filmParameter_gas = 1; 
filmParameter_vapor = 0.333; 
filmParameter_liquid = 0; 
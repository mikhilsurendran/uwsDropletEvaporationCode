...
%% This function writes the boiling points to a file. 

function writeBoilingPoint (bpOne, bpTwo)

filename = 'boilingPoints.m';

fileID = fopen(filename,'w');

fprintf(fileID, '%s%f%s\n', 'compOneBoilingPoint = ', bpOne,';');
fprintf(fileID, '%s%f%s\n', 'compTwoBoilingPoint = ', bpTwo,';');

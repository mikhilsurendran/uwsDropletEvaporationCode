...
%% This function calculates the combined viscosity of of the constituent vapors of the film around the evaporating droplet.
%  Wilke's mixture rule is used. Method of implementation can be improved
%  using matrices. 

function [dynamicViscosity] = calFilmViscosity(mu1, mu2, mu3, moleFraction1, moleFraction2, moleFraction3, molecularWeightOne, molecularWeightTwo, gas, calMethod)
...
%% calculate the viscosity of the film.
...
if mikhil==1
    ...
    if mu(1,2) ~= 0
        ...
        for i = 1:3
            ...
            dynamicViscosity = dynamicViscosity + (numerator / denominator);

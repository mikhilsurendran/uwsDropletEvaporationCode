...
%% This function evaluates the mass fractions of the constituents of the film.

function [compOneMassFraction, compTwoMassFraction, ambGasMassFraction] = calFilmMassFractions(massFractionOne_surf, massFractionTwo_surf, massFractionOne_inf, massFractionTwo_inf, calMethod)
...
if mikhil == 1
    ...
    compOneMassFraction = massFractionOne_surf * (1-filmRulePara) + massFractionOne_inf * filmRulePara ;
    
    compTwoMassFraction = massFractionTwo_surf * (1-filmRulePara) + massFractionTwo_inf * filmRulePara ;

    if compOneMassFraction < 0 

        compOneMassFraction = 0 ; 

    end

    if compTwoMassFraction < 0 

        compTwoMassFraction = 0 ; 

...
%% This function calculates the mass fraction of vapors at the droplet surface. 

function [massFractionOne, massFractionTwo] = calSurfaceVapMassFrac(compOneVapMoleFraction, compTwoVapMoleFraction, molecularWeightOne, molecularWeightTwo, ambMolecularWeight, calMethod)
...
if mikhil == 1
    ...
    ambGasMoleFraction = 1 - (compOneVapMoleFraction + compTwoVapMoleFraction); 

    mixtureMolarMass = compOneVapMoleFraction * molecularWeightOne + compTwoVapMoleFraction * molecularWeightTwo + ambGasMoleFraction * ambMolecularWeight; 

    massFractionOne = (compOneVapMoleFraction * molecularWeightOne)/mixtureMolarMass; 

    massFractionTwo = (compTwoVapMoleFraction * molecularWeightTwo)/mixtureMolarMass;

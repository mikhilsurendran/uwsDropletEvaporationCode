...
%% This function calculates the reynolds number for the flow around the droplet.  
%  Inputs and outputs are in SI units.

function [Reynolds] = calReynolds(density, V, d, mu, ambientTemperature, I, writeData, calMethod)
...
if saveDataToFile == 1
    ...
    filename = [savePath,'reynolds','_',num2str(ambientTemperature),'K.txt'];

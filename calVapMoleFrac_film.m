...
%% This function evaluates the molefractions of the constituents of the film based on their mass fractions and molecular weights

function [compOneMoleFraction, compTwoMoleFraction, ambGasMoleFraction] = calVapMoleFrac_film(compOneMassFraction, compTwoMassFraction, molecularWeightOne, molecularWeightTwo, ambMolecularWeight)

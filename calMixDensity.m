...
%% This function calculates the density of a binary liquid mixture. 

function [mixtureDensity] = calMixDensity(liquidOneDensity, liquidTwoDensity, liquidTwoMassFraction, calMethod)
...
if mikhil == 1
    ...
    if liquidTwoMassFraction > 0 
    
        liquidOneMassFraction = 1 - liquidTwoMassFraction ; 

        A = liquidOneMassFraction / liquidOneDensity ; 

        B = liquidTwoMassFraction / liquidTwoDensity ; 

        mixtureDensity  = 1/(A+B) ;
    
    else 
    
        mixtureDensity = liquidOneDensity ;

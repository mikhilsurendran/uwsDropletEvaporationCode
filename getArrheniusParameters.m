...
%% This function defines the kinetic parameters for the Arrhenius equation used to model the depletion of urea. 
%  Currently uses the parameters given by Birkhold et al. (2007)
%  Can be modified to take other parameters. 

function [preExponentialFactor, activationEnergy] = getArrheniusParameters(reference)

birkhold = strcmp(reference, 'birkhold');

if birkhold == 1
    
    preExponentialFactor = 0.42 ; 
    activationEnergy = 69000 ;
